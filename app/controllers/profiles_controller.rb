class ProfilesController < ApplicationController
  ...
  def create
    ...
    #@profile.avatar = params[:avatar] # Assign a file like this, or

    # like this
    # File.open('app/assets/images/1.jpg') do |f|
    #   @profile.avatar = f
    # end
    ...
    # u.save!
     ...
     # uploader.store!(@profile.avatar)
     # uploader.retrieve_from_store!(@profile.avatar)
